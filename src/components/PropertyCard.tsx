...
export function PropertyCard({
  ...
  return (
    <article
      ...
      className="group cursor-pointer overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-forest-900/10"
    >
      <div className="relative aspect-[1.28] overflow-hidden">
        ...
        <span className="absolute right-4 top-4 rounded-full bg-white/90 px-3 py-1.5 text-[11px] font-bold text-slate-600 backdrop-blur-sm">
          {property.category}
        </span>
          ...
          <button
            ...
            className={`absolute bottom-4 right-4 grid h-10 w-10 place-items-center rounded-full backdrop-blur-md transition disabled:opacity-60 ${
              saved
                ...
                : 'bg-white/90 text-slate-600 hover:bg-white hover:text-gold-600'
            }`}
          >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <a
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-lg bg-forest-50 px-3 py-2 text-xs font-bold text-forest-800 transition hover:bg-forest-800 hover:text-white"
          >
